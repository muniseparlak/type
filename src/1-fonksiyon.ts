...
function kardesPayi (firstName?: string): string{
    if(firstName){
        return `Bir tane ${firstName} için, bir de benim için`
    }else{
        return "Bir tane senin için, bir de benim için."
    }
}
console.log(kardesPayi()); // "Bir tane senin için, bir de benim için."
console.log(kardesPayi("Ahmet")); // "Bir tane Ahmet için, bir de benim için."
